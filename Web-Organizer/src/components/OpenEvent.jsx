...
function OpenEvent({ inputValue, setInputValue }) {
    ...
    // setSortedEvent(fetchMarketEvents);
    // useEffect(()=>{
    //   if(inputValue === ""){
    //     setSortedEvent(fetchMarketEvents)
    //   } else
    //   {
    //     setSortedEvent(
    //       fetchMarketEvents.sort((fetchMarketEvents, inputValue) => fetchMarketEvents["name"] - inputValue));
...
const handleCloseClick = (index) => {
  ...
  async function purchase() {
    ...
    return (
        ...
        { inputValue ==="" && fetchMarketEvents.map((index) => (
              <Card
                hoverable
                actions={[
            ...
            {inputValue !=="" && fetchMarketEvents.filter(fetchMarketEvents => (fetchMarketEvents["name"].includes(inputValue) )).map((index) => (
              <Card
                hoverable
                actions={[
                  <Tooltip title="Read Event Description">
